...
static constexpr char WEALTH_HISTORY_FILE_PATH[] = "/wealth-history.bin";
static constexpr char BATTERY_LOG_FILE_PATH[] = "/battery-log.bin";
static constexpr uint32_t CONFIG_VERSION = 2;
static constexpr uint32_t HISTORY_VERSION = 2;
static constexpr char FIRMWARE_VERSION[] = "2026.06.05.1";
static constexpr char GITHUB_REPO_SLUG[] = "mr21free/freedom-clock";
static constexpr char GITHUB_RELEASES_URL[] = "https://github.com/mr21free/freedom-clock/releases";
static constexpr char GITHUB_LATEST_RELEASE_API_URL[] = "https://api.github.com/repos/mr21free/freedom-clock/releases/latest";
